    ...
    <>
      ...
      <section className="drawings-band paper" id="drawings">
        <div className="drawings-intro">
          ...
          <p className="drawing-printed-text">
      ...
      <section className="specialties paper">
        ...
        <ul>
          <li>
            ...
            <small className="drawing-printed-text">
              Depth, contrast, fine detail
            </small>
          </li>
          <li>
            <span className="line-icon" aria-hidden="true">
          ...
          <li>
            ...
            <small className="drawing-printed-text">Graphic storytelling</small>
          </li>
          <li>
            <span className="line-icon" aria-hidden="true">
              ♜
          ...
          <li>
            ...
            <small className="drawing-printed-text">Organic form studies</small>
          </li>
        </ul>
      </section>
        ...
        <ol>
          <li>
            ...
            <div>
              ...
              <p className="drawing-printed-text">
                Share the idea, placement, scale, and direction.
              </p>
            </div>
          </li>
          <li>
            ...
            <div>
              ...
              <p className="drawing-printed-text">
                Creative process details forthcoming.
              </p>
            </div>
          </li>
          <li>
